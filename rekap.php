                        ...
                        <div class="col-lg-12">
                            <form action="#" method="POST" accept-charset="utf-8">
                                <div class="form-group">
                                    <label for="tgl_mulai" style="font-size: 16pt">Tanggal</label>
                                    <input type='text' id="tgl_mulai" class='form-control datepicker-here' readonly="readonly" style="background:white;" data-language='en' name="tgl_mulai" autocomplete="off" class="form-control" required>
                                </div>
                                <div class="text-center">
                                    <input type="submit" id="submit" class="btn btn-block btn-lg btn-orange" value="Tampilkan">
                                </div>
                            </form>
                        </div>
                    </div>
