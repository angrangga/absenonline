...
<body>
        ...
        <div id="body">
            <nav class="navbar navbar-dark fixed-top" style="background-color: white; border-bottom: 0.3em solid #ccc">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="/absenonline/output">LAPORAN ABSEN</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item active" href="/absenonline/output/export.php">EXPORT FOR SUNFISH</a>
                </div>
            </nav>
            <div class="content">
    ...
    <script>
        ...
        $('#tgl_mulai').datepicker({
            ...
            maxDate : new Date(),
            minDate : mindate,
        }).data('datepicker').selectDate(kemarin);
